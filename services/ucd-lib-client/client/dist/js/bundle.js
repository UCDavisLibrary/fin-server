...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/window.JSCompiler_renameProperty=function(e,t){return e}},function(e,t,n){"use strict";var i=n(27),r=(n(9),n(77),n(6),n(23)),s=n(18),a=n(39),o=n(3),l=n(0);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let c=!1;function h(){if(o.c&&!o.i){if(!c){c=!0;const e=document.createElement("style");e.textContent="dom-bind,dom-if,dom-repeat{display:none;}",document.head.appendChild(e)}return!0}return!1}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const i=!(window.ShadyDOM&&window.ShadyDOM.inUse);let r,s;function a(e){r=(!e||!e.shimcssproperties)&&(i||Boolean(!navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/)&&window.CSS&&CSS.supports&&CSS.supports("box-shadow","0 0 0 var(--foo)")))}window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(s=window.ShadyCSS.cssBuild);const o=Boolean(window.ShadyCSS&&window.ShadyCSS.disableRuntime);window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?r=window.ShadyCSS.nativeCss:window.ShadyCSS?(a(window.ShadyCSS),window.ShadyCSS=void 0):a(window.WebComponents&&window.WebComponents.flags);const l=r},function(e,t,n){e.exports={BaseModel:n(82),BaseStore:n(84),BaseService:n(86),BaseMixin:n(88),Mixin:n(89),EventBus:n(28),EventInterface:n(90),LitCorkUtils:n(91),fetch:n(56),LightDom:n(92)}},function(e,t,n){"use strict";n.d(t,"c",(function(){return o})),n.d(t,"b",(function(){return l})),n.d(t,"a",(function(){return c}));n(6);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/class r{constructor(){this.start=0,this.end=0,this.previous=null,this.parent=null,this.rules=null,this.parsedCssText="",this.cssText="",this.atRule=!1,this.type=0,this.keyframesName="",this.selector="",this.parsedSelector=""}}function s(e){return function e(t,n){let i=n.substring(t.start,t.end-1);if(t.parsedCssText=t.cssText=i.trim(),t.parent){let e=t.previous?t.previous.end:t.parent.start;i=n.substring(e,t.start-1),i=function(e){return e.replace(/\\([0-9a-f]{1,6})\s/gi,(function(){let e=arguments[1],t=6-e.length;for(;t--;)e="0"+e;return"\\"+e}))}(i),i=i.replace(h.multipleSpaces," "),i=i.substring(i.lastIndexOf(";")+1);let r=t.parsedSelector=t.selector=i.trim();t.atRule=0===r.indexOf(u),t.atRule?0===r.indexOf(p)?t.type=o.MEDIA_RULE:r.match(h.keyframesRule)&&(t.type=o.KEYFRAMES_RULE,t.keyframesName=t.selector.split(h.multipleSpaces).pop()):0===r.indexOf(d)?t.type=o.MIXIN_RULE:t.type=o.STYLE_RULE}let r=t.rules;if(r)for(let t,i=0,s=r.length;i<s&&(t=r[i]);i++)e(t,n);return t}(function(e){let t=new r;t.start=0,t.end=e.length;let n=t;for(let i=0,s=e.length;i<s;i++)if(e[i]===l){n.rules||(n.rules=[]);let e=n,t=e.rules[e.rules.length-1]||null;n=new r,n.start=i+1,n.parent=e,n.previous=t,e.rules.push(n)}else e[i]===c&&(n.end=i+1,n=n.parent||t);return t}(e=e.replace(h.comments,"").replace(h.port,"")),e)}function a(e,t,n=""){let i="";if(e.cssText||e.rules){let n=e.rules;if(n&&!function(e){let t=e[0];return Boolean(t)&&Boolean(t.selector)&&0===t.selector.indexOf(d)}(n))for(let e,r=0,s=n.length;r<s&&(e=n[r]);r++)i=a(e,t,i);else i=t?e.cssText:function(e){return function(e){return e.replace(h.mixinApply,"").replace(h.varApply,"")}(e=function(e){return e.replace(h.customProp,"").replace(h.mixinProp,"")}(e))}(e.cssText),i=i.trim(),i&&(i="  "+i+"\n")}return i&&(e.selector&&(n+=e.selector+" "+l+"\n"),n+=i,e.selector&&(n+=c+"\n\n")),n}const o={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1e3},l="{",c="}",h={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},d="--",p="@media",u="@";var f=n(15);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const k="_applyShimCurrentVersion",I="_applyShimNextVersion",D="_applyShimValidatingVersion",j=Promise.resolve();function N(e){let t=V[e];t&&function(e){e[k]=e[k]||0,e[D]=e[D]||0,e[I]=(e[I]||0)+1}(t)}function U(e){return e[k]===e[I]}function B(e){return!U(e)&&e[D]===e[I]}function F(e){e[D]=e[I],e._validating||(e._validating=!0,j.then((function(){e[k]=e[I],e._validating=!1})))}n(50);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */
const J=/:host\(:dir\((ltr|rtl)\)\)/g,W=':host([dir="$1"])',X=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Q=':host([dir="$2"]) $1',ee=/:dir\((?:ltr|rtl)\)/,te=Boolean(window.ShadyDOM&&window.ShadyDOM.inUse),ne=[];let ie=null,re="";function se(){re=document.documentElement.getAttribute("dir")}function ae(e){if(!e.__autoDirOptOut){e.setAttribute("dir",re)}}function oe(){se(),re=document.documentElement.getAttribute("dir");for(let e=0;e<ne.length;e++)ae(ne[e])}const le=Object(G.a)(e=>{te||ie||(se(),ie=new MutationObserver(oe),ie.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const t=Object(Z.a)(e);class n extends t{static _processStyleText(e,n){return e=t._processStyleText.call(this,e,n),!te&&ee.test(e)&&(e=this._replaceDirInCssText(e),this.__activateDir=!0),e}static _replaceDirInCssText(e){let t=e;return t=t.replace(J,W),t=t.replace(X,Q),t}constructor(){super(),this.__autoDirOptOut=!1}ready(){super.ready(),this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){t.prototype.connectedCallback&&super.connectedCallback(),this.constructor.__activateDir&&(ie&&ie.takeRecords().length&&oe(),ne.push(this),ae(this))}disconnectedCallback(){if(t.prototype.disconnectedCallback&&super.disconnectedCallback(),this.constructor.__activateDir){const e=ne.indexOf(this);e>-1&&ne.splice(e,1)}}}return n.__activateDir=!1,n});n(76);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const s=Object(i.a)(e=>{return class extends e{_addEventListenerToNode(e,t,n){Object(r.a)(e,t,n)||super._addEventListenerToNode(e,t,n)}_removeEventListenerFromNode(e,t,n){Object(r.b)(e,t,n)||super._removeEventListenerFromNode(e,t,n)}}})},function(e,t,n){"use strict";n.d(t,"a",(function(){return c}));n(6);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
</custom-style>`;i.setAttribute("style","display: none;"),document.head.appendChild(i.content)},function(e,t,n){"use strict";n(7);var i=n(54),r=n(55),s=n(9),a=n(5);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Object(s.a)({_template:a.a`
    ...
    <slot></slot>
`,is:"iron-pages",behaviors:[i.a,r.a],properties:{activateEvent:{type:String,value:null}},observers:["_selectedPageChanged(selected)"],_selectedPageChanged:function(e,t){this.async(this.notifyResize)}})},function(e,t,n){"use strict";n(41),n(35);
/**
@license
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const r={templatize(e,t){this._templatizerTemplate=e,this.ctor=Object(i.b)(e,this,{mutableData:Boolean(t),parentModel:this._parentModel,instanceProps:this._instanceProps,forwardHostProp:this._forwardHostPropV2,notifyInstanceProp:this._notifyInstancePropV2})},stamp(e){return new this.ctor(e)},modelForElement(e){return Object(i.a)(this._templatizerTemplate,e)}}},function(e,t,n){"use strict";n.d(t,"a",(function(){return s}));var i=n(18);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let r;r=i.a._mutablePropertyChange;const s={properties:{mutableData:Boolean},_shouldPropertyChange(e,t,n){return r(this,e,t,n,this.mutableData)}}},function(e){e.exports=JSON.parse('{"http://rightsstatements.org/vocab/InC/1.0/":{"text":"IN COPYRIGHT","icon":"InC"},"http://rightsstatements.org/vocab/InC-OW-EU/1.0/":{"text":"IN COPYRIGHT - EU ORPHAN WORK","icon":"InC"},"http://rightsstatements.org/vocab/InC-EDU/1.0/":{"text":"IN COPYRIGHT - EDUCATIONAL USE PERMITTED","icon":"InC"},"http://rightsstatements.org/vocab/InC-NC/1.0/":{"text":"IN COPYRIGHT - NON-COMMERCIAL USE PERMITTED","icon":"InC"},"http://rightsstatements.org/vocab/InC-RUU/1.0/":{"text":"IN COPYRIGHT - RIGHTS-HOLDER(S) UNLOCATABLE OR UNIDENTIFIABLE","icon":"InC"},"http://rightsstatements.org/vocab/NoC-NC/1.0/":{"text":"NO COPYRIGHT - NON-COMMERCIAL USE ONLY","icon":"NoC"},"http://rightsstatements.org/vocab/NoC-OKLR/1.0/":{"text":"NO COPYRIGHT - OTHER KNOWN LEGAL RESTRICTIONS","icon":"NoC"},"http://rightsstatements.org/vocab/NoC-US/1.0/":{"text":"NO COPYRIGHT - UNITED STATES","icon":"NoC"},"http://rightsstatements.org/vocab/CNE/1.0/":{"text":"COPYRIGHT NOT EVALUATED","icon":"Other"},"http://rightsstatements.org/vocab/UND/1.0/":{"text":"COPYRIGHT UNDETERMINED","icon":"Other"},"http://rightsstatements.org/vocab/NKC/1.0/":{"text":"NO KNOWN COPYRIGHT","icon":"Other"}}')},function(e,t,n){"use strict";var i=n(4),r=n(65),s=n.n(r);class a extends i.a{static get properties(){return{placeholder:{type:String,value:""},browse:{type:Object,observer:"_onBrowseOptionsChange",value:()=>({})}}}static get template(){let e=document.createElement("template");return e.innerHTML=s.a,e}get browseValue(){return this._browseValue||"Browse"}set browseValue(e){this._browseValue=e,this.$.select.value=e}get value(){return this.$.input.value}set value(e){this.$.input.value=e}_fireSearch(){this.dispatchEvent(new CustomEvent("search",{detail:this.$.input.value,bubbles:!0,composed:!0}))}_fireBrowse(){this.dispatchEvent(new CustomEvent("browse",{detail:this.$.select.value,bubbles:!0,composed:!0}))}_onKeyUp(e){13===e.which&&this._fireSearch()}_onBrowseOptionsChange(){var e;this.$.select.innerHTML="",(e=document.createElement("option")).value="Browse",e.textContent="Browse",e.setAttribute("selected","selected"),this.$.select.appendChild(e),(e=document.createElement("option")).value="",e.textContent="All Items",this.$.select.appendChild(e);for(let t in this.browse)(e=document.createElement("option")).textContent=this.browse[t],e.value=t,this.$.select.appendChild(e)}}customElements.define("fin-search-box",a)},function(e,t,n){"use strict";var i=n(4);class r extends i.a{static get properties(){return{height:{value:36,type:Number,observer:"_updateHeight"},flipped:{value:!1,type:Boolean,observer:"_flip"}}}static get template(){return i.b`
    <style>
      :host {
        display: block;
        overflow: hidden;
...
*/const f=r.b`
  ...
  <slot></slot>`;f.setAttribute("strip-whitespace",""),Object(u.a)({_template:f,is:"paper-button",behaviors:[p],properties:{raised:{type:Boolean,reflectToAttribute:!0,value:!1,observer:"_calculateElevation"}},_calculateElevation:function(){this.raised?d._calculateElevation.apply(this):this._setElevation(0)}});n(71),n(72),n(41),n(35);
/**
@license
Copyright (c) 2014 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</iron-iconset-svg>`;document.head.appendChild(m.content);n(12),n(70);var v=n(61),y=n.n(v);let _=document.createElement("div");_.style.display="none",_.innerHTML=y.a,document.head.appendChild(_);var b=n(62),w=n.n(b);const z=document.createElement("template");z.innerHTML=w.a,document.head.appendChild(z.content);n(93);var C=n(64),S=n.n(C),M=n(26),x=n.n(M);class E extends(Mixin(i.a).with(EventInterface,x.a)){static get template(){return i.b`<iron-icon icon="fin-icons:account" style="width: 40px; height:40px"></iron-icon>`}constructor(){super(),this.active=!0}_onAuthUpdate(e){"loggedIn"===e.state?this.style.display="block":this.style.display="none"}}customElements.define("app-auth-header",E);n(80);var O=n(33),A=n.n(O),L=n(32),H=n.n(L),P=n(24),T=n.n(P);class R extends(Mixin(i.a).with(EventInterface,A.a,H.a,T.a)){static get properties(){return{selectedCollection:{type:String,value:""}}}static get template(){let e=document.createElement("template");return e.innerHTML=S.a,e}constructor(){super(),this.active=!0}async ready(){super.ready(),this._setCollections(await this.CollectionModel.overview())}_setCollections(e){let t=e.payload,n={};t.forEach(e=>{n[e["@id"]]=e.name}),this.$.searchInput.browse=n}_onBrowse(e){let t=e.detail;if(this.$.searchInput.browseValue="Browse",!t||"Browse"===t)return this.RecordModel.setSearchLocation(this._getEmptySearchDocument());this._setWindowLocation(t)}_onSearch(e){let t=this._getCurrentSearchDocument();this._setPaging(t,0),this._setTextFilter(t,e.detail),this.RecordModel.setSearchLocation(t)}_onRecordSearchUpdate(e){try{this.$.searchInput.value=e.searchDocument.text||""}catch(e){this.$.searchInput.value=""}}_onSelectedCollectionUpdate(e){this.selectedCollection=e}}customElements.define("app-search-header",R);var V=n(66),k=n.n(V);class I extends(Mixin(i.a).with(EventInterface)){static get properties(){return{collection:{type:Object,value:null},record:{type:Object,value:null},name:{type:String,value:""}}}static get template(){let e=document.createElement("template");return e.innerHTML=k.a,e}constructor(){super(),this.active=!0,this._injectModel("AppStateModel","CollectionModel","RecordModel")}async ready(){super.ready(),this.$.layout.style.width=window.innerWidth-55+"px",window.addEventListener("resize",()=>{this.$.layout.style.width=window.innerWidth-55+"px"}),this._onAppStateUpdate(await this.AppStateModel.get())}async _onAppStateUpdate(e){e.lastLocation&&"search"===e.lastLocation.page?this.lastSearch=e.lastLocation.pathname:this.lastSearch=null,this.record=null,this.collection=null,"search"===e.location.page&&e.selectedCollection&&(this.collection=e.selectedCollection),"record"===e.location.page&&(this.currentRecordId=e.location.pathname,this.record=await this.RecordModel.get(this.currentRecordId),this.record=this.record.payload,this.record.collectionId?this.collection=await this.CollectionModel.get(this.record.collectionId):this.collection=null)}_onCollectionClicked(e){"keyup"===e.type&&13!==e.which||this.AppStateModel.setLocation(this.lastSearch||(this.collection?this.collection["@id"]:"/search"))}}customElements.define("app-search-breadcrumb",I);var D=n(67),j=n.n(D);class N extends(Mixin(i.a).with(EventInterface,x.a)){static get template(){let e=document.createElement("template");return e.innerHTML=j.a,e}static get properties(){return{loggedIn:{type:Boolean,value:!1},user:{type:Object,value:()=>{}}}}constructor(){super(),this.active=!0}_onAuthUpdate(e){"loggedIn"===e.state?(this.user=e.user,this.loggedIn=!0):this.loggedIn=!1}}customElements.define("app-auth-footer",N);var U=n(68),B=n.n(U);class F extends(Mixin(i.a).with(EventInterface,T.a)){static get template(){let e=document.createElement("template");return e.innerHTML=B.a,e}static get properties(){return{}}constructor(){super(),this.active=!0}}customElements.define("app-footer",F);n(81);var q=n(69),$=n.n(q);n.d(t,"FinApp",(function(){return K}));class K extends(Mixin(i.a).with(EventInterface,T.a,x.a,H.a,A.a)){static get template(){return Object(i.b)([$.a])}static get properties(){return{page:{type:String,value:"loading"},appRoutes:{type:Array,value:()=>APP_CONFIG.appRoutes},showSearchHeader:{type:Boolean,value:!1},showBreadcrumb:{type:Boolean,value:!1},drawerOpen:{type:Boolean,value:!1}}}constructor(){super(),this.active=!0,this.SEARCH_HEADER_PAGES=["about","record","search"],this.BREADCRUMB_PAGES=["record","search"],this.loadedPages={}}ready(){let e=document.querySelector("#loading");e&&document.body.removeChild(e),super.ready(),this.AuthModel.store.setUser(APP_CONFIG.user)}async _onAppStateUpdate(e){if(this.drawerOpen=!!e.filtersDrawerOpen,e.location.page===this.page)return;this.showBreadcrumb=this.BREADCRUMB_PAGES.includes(e.location.page),this.showSearchHeader=this.SEARCH_HEADER_PAGES.includes(e.location.page),this.appState=e,window.scrollTo(0,0);let t=e.location.page;this.loadedPages[t]||(this.page="loading",this.loadedPages[t]=this.loadPage(t)),await this.loadedPages[t],this.page=t}loadPage(e){return"home"===e?n.e(5).then(n.bind(null,202)):"search"===e?Promise.all([n.e(0),n.e(10),n.e(7)]).then(n.bind(null,207)):"record"===e?Promise.all([n.e(0),n.e(9),n.e(6)]).then(n.bind(null,208)):"about"===e?n.e(4).then(n.bind(null,203)):void 0}_toggleDrawer(){this.AppStateModel.set({filtersDrawerOpen:!this.drawerOpen})}}customElements.define("fin-app",K)},function(e,t,n){"use strict";n.r(t);var i=n(4),r=(n(7),n(9)),s=n(2);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
