...
class AutoGenerator extends MessageServer {
  ...
  async handleMessage(msg) {
    ...
    if( this.isAutoGeneratedContainer(eventTypes) ) return;
  ...
  isAutoGeneratedContainer(types) {
    return (
      eventTypes.indexOf(this.AUTO_GENERATED_CONTAINER_TYPE) > -1 ||
      eventTypes.indexOf(this.AUTO_GENERATED_CONTAINER_TYPE_COMPACT) > -1
    );
  }
